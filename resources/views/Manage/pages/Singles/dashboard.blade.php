                                ...
                                <div class="card card-stats radius shadow-2xl">
                                    ...
                                    <div class="card-body radius shadow-2xl">
                                        <div class="row">
                                            <div class="col">
                                                <a href="">
                                                    <h2 class="card-title text-uppercase text-muted mb-0">Total Number of Students</h2>
                                ...
                                <div class="card card-stats radius shadow-2xl">
                                    ...
                                    <div class="card-body radius shadow-2xl">
                                        <div class="row">
                                            <div class="col">
                                                <a href="">
                                                    <h2 class="card-title text-uppercase text-muted mb-0">No. of Trimester Courses</h2>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <span class="h2 font-weight-bold text-white mb-0">1</span>
                                            </div>
                                            <div class="col-auto">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <span class="h2 font-weight-bold text-white mb-0">2</span>
                                            </div>
                                            <div class="col-auto">
                                                <div class="icon icon-shape bg-red text-white rounded-circle shadow">
                                                    <i class="fas fa-calendar-minus"></i>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control datepicker  @error('date') is-invalid @enderror " name="date" id="input-date" placeholder="Select date" type="text" value="07/25/2024">
                                                @error('date')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
