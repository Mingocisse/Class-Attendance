                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush datatable-buttons">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="sort" data-sort="subject">Course</th>
                                    <th scope="col" class="sort" data-sort="teacher">Lecturer</th>
                                ...
                                @foreach ($attendances ?? []  as $attendance)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('attendance.show', $attendance) }}" class="btn btn-sm bg-blue-500 text-white m-0 radius" title="edit">
