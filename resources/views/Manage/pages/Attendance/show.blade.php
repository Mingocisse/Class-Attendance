                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body text-center bg-white-100 radius shadow-2xl">
                            ...
                            <p class="text-bold">{{ $attendance->students->count() }} <i class="fas fa-users-class text-blue"></i></p>
                                ...
                                <div class="col-md-6">
                                    <div class="card bg-gradient-default radius shadow-2xl">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <h5 class="card-title text-uppercase text-white mb-0">Total Present</h5>
                                                    <span class="h2 font-weight-bold text-white mb-0">{{ $total_present }}</span>
                                                </div>
                                                <div class="col-auto">
                                ...
                                <div class="col-md-6">
                                    <div class="card bg-gradient-default radius shadow-2xl">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <h5 class="card-title text-uppercase text-white mb-0">Total Absent</h5>
                                                    <span class="h2 font-weight-bold text-white mb-0">{{ $total_absent }}</span>
                                                </div>
                                                <div class="col-auto">
                                                    <div class="icon icon-shape bg-red text-white rounded-circle shadow">
                                                        <i class="fas fa-calendar-minus"></i>
                                        ...
                                        <table class="table table-flush">
                                            <thead class="thead-light">
                                                <tr>
                                                    ...
                                                    <th scope="col" class="sort" data-sort="action">Attendance Status</th>
                                                </tr>
                                            </thead>
                                            <tbody class="list">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="">
                                                            <div class="custom-control custom-radio d-inline mr-2">
                                                                <input type="radio" id="radio-{{ $student->id }}-on" name="status[{{ $student->id }}]" value="on" class="custom-control-input" {{ $student->pivot->status == 1 ? 'checked' : '' }}>
                                                                <label class="custom-control-label" for="radio-{{ $student->id }}-on">Present</label>
                                                            </div>
                                                            <div class="custom-control custom-radio d-inline">
                                                                <input type="radio" id="radio-{{ $student->id }}-off" name="status[{{ $student->id }}]" value="off" class="custom-control-input" {{ $student->pivot->status == 0 ? 'checked' : '' }}>
