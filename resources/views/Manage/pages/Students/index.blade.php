                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush datatable-buttons">
                                ...
                                <tr>
                                    <th scope="col" class="sort" data-sort="employee">First Name</th>
                                    <th scope="col" class="sort" data-sort="employee">Last Name</th>
                                    <th scope="col" class="sort" data-sort="employee">Index Number</th>
